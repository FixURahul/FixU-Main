        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <Link href="https://instagram.com" className="bg-gray-800 p-2 rounded-full hover:bg-gray-700 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/locations" className="text-gray-400 hover:text-white transition-colors">Service Locations</Link></li>
              ...
              <li><Link href="/cancellation-and-refund-policy" className="text-gray-400 hover:text-white transition-colors">Cancellation & Refund Policy</Link></li>
            </ul>
          </div>
