  ...
  return (
    <div className="bg-gray-100 py-12">
      <div className="container mx-auto px-4 max-w-4xl bg-white shadow-md rounded-lg p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">Last updated on 01-05-2025 11:28:29</p>
        
        <div className="space-y-6 text-gray-700">
          <p>
            These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between SHABRA SOFTECH SOLUTIONS PRIVATE LIMITED, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
          </p>
          ...
          <p>
            All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Patna, Bihar.
          </p>
